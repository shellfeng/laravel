		...
		<div class="row body">
			...
			<div class="col-md-2">
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="/admin/admin/adminlist">管理员列表</a></li>
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="/admin/user/userlist">会员列表</a></li>
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="/admin/types/index">分类列表</a></li>
					</ul>
				</div>
				<!-- 商品管理 -->
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="/admin/goods/goodsList">商品列表</a></li>
					</ul>
				</div>
				<!-- 订单管理 -->
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h2 class="panel-title" id="order"><span class="glyphicon glyphicon-list-alt"></span> 订单管理</h2>
					</div>
					<ul class="list-group">
					    <li class="list-group-item"><a href="/admin/order/index">订单列表</a></li>
					</ul>
				</div>
				<!-- 评论管理 -->
				<div class="panel panel-primary">
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="/admin/sys/syslist">系统配置</a></li>
					    <li class="list-group-item"><a href="/admin/sys/sliderlist">轮播图管理</a></li>
					    <li class="list-group-item"><a href="/admin/sys/adslist">广告管理</a></li>
					    <li class="list-group-item"><a href="/admin/sys/stypeslist">分类广告管理</a></li>
					</ul>
				</div>
			</div>
